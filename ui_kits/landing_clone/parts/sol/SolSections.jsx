...
export function SolDarkCards() {
  ...
  return (
    <section style={{ background: "var(--tp-blue-950)", padding: "70px 28px" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 22 }}>
        {cards.map((c, i) => (
...
export function PanelFlow() {
  ...
  return (
    <div style={{ background: "var(--tp-azul-profundo)", borderRadius: 22, padding: "34px 26px", minHeight: 360, display: "flex", flexDirection: "column", alignItems: "center", gap: 14 }}>
      <div style={{ display: "flex", gap: 60 }}>{tag("Marca 1")}{tag("Marca 2")}</div>
...
export function SolVideo() {
  return (
    <section style={{ background: "#fff" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "20px 28px 84px", display: "grid", gridTemplateColumns: "0.85fr 1.15fr", gap: 48, alignItems: "center" }}>
        <div>
...
export function SolTools() {
  ...
  return (
    <section style={{ background: "#fff" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "84px 28px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
        <div>
