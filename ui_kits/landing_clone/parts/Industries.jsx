...
export function Industries() {
  ...
  return (
    <section style={{ background: "var(--tp-slate-100)" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "84px 28px", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: 40, alignItems: "center" }}>
        <div>
  ...
  return (
    <section style={{ background: "#fff" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "84px 28px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(10, 1fr)", gap: 14 }}>
          {set.map((n, i) => (
