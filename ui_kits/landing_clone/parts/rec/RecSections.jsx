...
function ProgramRow({ tone, eyebrow, eyebrowColor, title, body, cta, visual, reverse, onCta }) {
  ...
  return (
    <div className="tp-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderRadius: 18, overflow: "hidden", background: tone.light }}>
...
function TechGrid() {
  ...
  return (
    <div className="tp-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, width: "min(340px,100%)" }}>
      {set.map((n, i) => (
...
export function GetInTouch() {
  return (
    <section style={{ background: "var(--tp-slate-50)" }}>
      <div className="tp-grid-2" style={{ maxWidth: 1240, margin: "0 auto", padding: "84px 28px", display: "grid", gridTemplateColumns: "0.9fr 1.1fr", gap: 48, alignItems: "start" }}>
        <div>
        ...
        <div style={{ background: "#fff", border: "1px solid var(--border-subtle)", borderRadius: 18, padding: "32px 34px", boxShadow: "var(--shadow-sm)" }}>
          <div className="tp-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18, marginBottom: 18 }}>
